...
const int siteID = 1234;
const int deviceID = 2; // Set the device ID here
const char* locationDescriptor = "inside"; // e.g., kitchen
const char* mqtt_server = "XXX.XXX.XXX.XXX"; // MQTT - B - No auth/wildcard.   ##YOUR MQTT BROKER HERE###
